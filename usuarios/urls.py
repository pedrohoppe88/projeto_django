...
urlpatterns = [
    ...
    path('listar_sessoes.html/', views.sucesso, name='sucesso'),
    ...
    path('confirmar_retirada/', views.confirmar_retirada, name='confirmar_retirada'),
    path('confirmar_devolucao/', views.confirmar_devolucao, name='confirmar_devolucao'),
